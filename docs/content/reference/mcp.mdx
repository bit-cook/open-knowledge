...
To point an MCP client at this server, locally or over a tunnel from another machine, see [Connect remote agents](/docs/self-hosting/connecting-agents).
